...
- [x] 5.3 Define GitHub capability interface (issues, pull requests, repository management)
- [x] 5.4 Implement GitHub capability with abstract interface
...
- [x] 5.7 Define Kubernetes capability interface (resource management, status, mutations)
- [x] 5.8 Implement Kubernetes capability with cluster abstraction

## 6. Projection Protocol

- [x] 6.1 Define subscription protocol for UI surfaces
- [x] 6.2 Implement event delivery with ordering guarantees
- [x] 6.3 Add reconnection and event gap handling
- [x] 6.4 Implement subscription filtering by event type

## 7. Terminal Projection

- [x] 7.1 Implement terminal event rendering with styling
- [x] 7.2 Implement user input capture and event emission
- [x] 7.3 Add session management through CLI
- [x] 7.4 Implement streaming display updates
...
- [x] 9.4 Create integration tests for projection protocol and terminal
- [x] 9.5 Create end-to-end tests for complete interaction flows
- [x] 9.6 Add performance benchmarks for critical paths
