...
All tests pass: 112 tests across 10 suites.`,
  ...
  task: `Review the kayak-lab codebase for code quality, file decomposition needs, simplified abstractions, and test improvements. Follow the review checklist from AGENTS.md.
